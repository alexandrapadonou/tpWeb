...
var editingMode = { rect: 0, line: 1, ovale : 2 };
...
function Pencil(ctx, drawing, canvas) {
	...
	document.getElementById('butOvale').onclick = (_) => this.currEditingMode = editingMode.ovale
	...
	this.onInteractionUpdate = function (dnd) {
		...
		else if (this.currEditingMode === editingMode.ovale)
		{
			this.currentShape = new Ovale(dnd.initX, dnd.initY, this.currLineWidth, this.currColour, dnd.finalX, dnd.finalY);
        }
